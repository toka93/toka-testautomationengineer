...
public class ExcelTestParser implements ITestCaseParser {
	 ...
	 * @throws java.io.IOException is thrown when the file path is invalid or the
	 *                             file is not excel.
	 */
	...
	public int getCellValueAsInt(String sheetName, String testCaseName, String columnName) throws IOException {
		...
		System.out.println("value isss :" + value);
		int Value = Integer.parseInt(value);
		System.out.println("value in integer isss :" + Value);
	 ...
	 * 
	 * @param sheetName the name of the sheet.
	 * @return map of maps where the key of the first map is the sheet name. and key
	 *         of the inner maps is the name of the test cases.
	 */
	@Override
